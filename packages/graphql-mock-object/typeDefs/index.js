...
export const typeDefs = [FakeDirective, MockObject]
...
directive @fake(type:fake__Types!, options: fake__options = {}, locale:fake__Locale) on FIELD | SCALAR



scalar examples__JSON
directive @examples(values: [examples__JSON]!) on FIELD | SCALAR
